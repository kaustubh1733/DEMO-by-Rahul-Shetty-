...
public class Validation_01 {
	...
	public static void main(String[] args) {
		...
		String path = System.getProperty("user.dir")+"\\execute\\chromedriver.exe";
		...
		System.out.println("actualDefaultTextOnUserNameInputField : "+actualDefaultTextOnUserNameInputField);
